                ...
                bottomBar = {
                    NavigationBar {
                        ...
                        NavigationBarItem(
                            ...
                            icon = {
                                Icon(
                                    painter = HomeTabScreen.options.icon!!, //Aseguramos que esa variable nunca sea nula con !!
                        ...
                        NavigationBarItem(
                            ...
                            icon = {
                                Icon(
                                    painter = UserTabScreen.options.icon!!, //Aseguramos que esa variable nunca sea nula con !!
                                    contentDescription = null
                                )
                            },
                            onClick = {
                        ...
                        NavigationBarItem(
                            ...
                            icon = {
                                Icon(
                                    painter = MenuTabScreen.options.icon!!, //Aseguramos que esa variable nunca sea nula con !!
                                    contentDescription = null
                                )
                            },
                            onClick = {
